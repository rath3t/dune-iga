...
#ifndef DUNE_PYTHON_GRID_GRIDPART_MOD_HH
#define DUNE_PYTHON_GRID_GRIDPART_MOD_HH
...
struct DUNE_PRIVATE ProxyDataHandleMod
    : public Dune::CommDataHandleIF< ProxyDataHandleMod, double >
{
  ProxyDataHandleMod ( pybind11::object dataHandle )
...
// registerGridViewConstructorFromGridMod
// -----------------------------------
...
void registerGridViewConstructorFromGridMod ( pybind11::class_< GridView, options... > &cls, PriorityTag< 2 > )
{
...
void registerGridViewConstructorFromGridMod ( pybind11::class_< GridView, options... > &cls, PriorityTag< 1 > )
{
...
void registerGridViewConstructorFromGridMod ( pybind11::class_< GridView, options... > &, PriorityTag< 0 > )
{}
...
template< class GridView, class... options >
inline static void registerGridViewALT ( pybind11::handle scope, pybind11::class_< GridView, options... > cls )
{
  std::cout<<"registerGridView Are we here?"<<std::endl;
  ...
  detail::registerGridViewConstructorFromGridMod( cls, PriorityTag< 42 >() );
...
//    ProxyDataHandleMod proxyDataHandle( std::move( dataHandle ) );
...
#endif // #ifndef DUNE_PYTHON_GRID_GRIDPART_MOD_HH
