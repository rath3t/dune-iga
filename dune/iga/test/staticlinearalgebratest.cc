...
#include <dune/iga/eigenlinearalgebratraits.hh>
...
void testNURBSGridCurve() {
  ...
  using ControlPoint = Dune::IGA::NURBSPatchData<dim, dimworld,EigenLinearAlgebraTraits<double>>::ControlPointType;
  ...
  auto controlNet               = Dune::IGA::NURBSPatchData<dim, dimworld,EigenLinearAlgebraTraits<double>>::ControlPointNetType(dimsize, controlPoints);

  Dune::IGA::NURBSPatchData<dim, dimworld,EigenLinearAlgebraTraits<double>> patchData;
  ...
  IGA::NURBSGrid<dim, dimworld,EigenLinearAlgebraTraits<double>> grid(patchData);
  grid.globalRefine(3);
