...
public: // types
    ...
    using Poles = Dune::BlockVector<Vector>;
    using Weights = Dune::DynamicVector<double>;
...
private: // variables
    ...
    Index m_nb_poles_u;
    Index m_nb_poles_v;
    Dune::DynamicVector<double> m_knots_u;
    Dune::DynamicVector<double> m_knots_v;
    Poles m_poles;
    Dune::DynamicVector<double> m_weights;
