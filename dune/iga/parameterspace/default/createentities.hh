...
auto ParameterSpaceImpl<dim, dimworld, ScalarType>::makeElementID(const HostEntity<0>& ele) -> GlobalIdType {
...
template <int dim, int dimworld, typename ScalarType>
auto ParameterSpaceImpl<dim, dimworld, ScalarType>::idForTrimmedHostEdge(
    typename ParameterSpaceTraits::PersistentIndexType hostEdgeId,
    const typename ElementTrimData::EdgeInfo& trimmedEdge) -> GlobalIdType {
  using HostEdge            = typename ParameterSpaceTraits::template Codim<1>::HostParameterSpaceGridEntity;
  using PersistentIndexType = typename ParameterSpaceTraits::PersistentIndexType;
...
template <int dim, int dimworld, typename ScalarType>
void ParameterSpaceImpl<dim, dimworld, ScalarType>::createAndSaveElementInfo(
...
template <int dim, int dimworld, typename ScalarType>
void ParameterSpaceImpl<dim, dimworld, ScalarType>::createSubEntities(int level) {
