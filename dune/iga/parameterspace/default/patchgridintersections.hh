...
class TrimmedLeafIntersection
{
  ...
  using HostLeafIntersection = typename GridImp::ParameterSpace::ParameterSpaceTraits::HostLeafIntersection;
  using EdgeInfo             = typename GridImp::ParameterSpace::ParameterSpaceTraits::template Codim<1>::EntityInfo;
...
class TrimmedLevelIntersection
{
  ...
  using HostLevelIntersection = typename GridImp::ParameterSpace::ParameterSpaceTraits::HostLevelIntersection;
