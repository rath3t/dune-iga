...
{
  using TrimmingCurve = typename GridImp::GridFamily::ParameterSpaceTraits::TrimmingCurve;
  using ParameterType = typename GridImp::GridFamily::ParameterSpace::ParameterType;
