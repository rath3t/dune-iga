...
namespace Dune::IGANEW::Concept {
  ...
  concept Trimmer = T::isValid and requires(T trimmer, const typename T::ParameterType& param,
    ...
    // T::ReferenceElementType>; Uncomment the line above when the referenceElement method is added to the Trimmer
    // concept.
    ...
    // std::convertible_to<std::optional<std::reference_wrapper<const typename T::ElementTrimData>>>; Uncomment the line
    // above when the trimData method is added to the Trimmer concept.
