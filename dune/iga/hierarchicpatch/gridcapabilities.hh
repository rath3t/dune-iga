...
namespace Dune {
  ...
  namespace Capabilities {
     ...
     * \ingroup PatchGrid
     */
    template <std::size_t dim, std::size_t dimworld, typename ScalarType, template<int,typename > typename TrimmerType, int codim>
    ...
    template <std::size_t dim, std::size_t dimworld, typename ScalarType, template<int,typename > typename TrimmerType, int codim>
    struct hasEntity<const Dune::Grid<dim, dimworld, ScalarType, IGANEW::PatchGridFamily<dim, dimworld, TrimmerType,ScalarType>>,
                     codim> {
      using ParameterSpaceGrid = typename TrimmerType<dim,ScalarType>::ParameterSpaceGrid;
      static const bool v      = hasEntity<ParameterSpaceGrid, codim>::v;
    };
    ...
    template <std::size_t dim, std::size_t dimworld, typename ScalarType, template<int,typename > typename TrimmerType, int codim>
    struct hasEntityIterator<Dune::Grid<dim, dimworld, ScalarType, IGANEW::PatchGridFamily<dim, dimworld, TrimmerType,ScalarType>>,
                             codim> {
      using ParameterSpaceGrid = typename TrimmerType<dim,ScalarType>::ParameterSpaceGrid;
      static const bool v      = hasEntityIterator<ParameterSpaceGrid, codim>::v;
    };
    ...
    template <std::size_t dim, std::size_t dimworld, typename ScalarType, template<int,typename > typename TrimmerType, int codim>
    struct canCommunicate<Dune::Grid<dim, dimworld, ScalarType, IGANEW::PatchGridFamily<dim, dimworld, TrimmerType,ScalarType>>,
                          codim> {
      using ParameterSpaceGrid = typename TrimmerType<dim,ScalarType>::ParameterSpaceGrid;
      static const bool v      = canCommunicate<ParameterSpaceGrid, codim>::v;
    };
     ...
     * \ingroup PatchGrid
     */
    template <std::size_t dim, std::size_t dimworld, typename ScalarType, template<int,typename > typename TrimmerType>
    ...
    template <std::size_t dim, std::size_t dimworld, typename ScalarType, template<int,typename > typename TrimmerType>
    struct threadSafe<Dune::Grid<dim, dimworld, ScalarType, IGANEW::PatchGridFamily<dim, dimworld, TrimmerType,ScalarType>>> {
      using ParameterSpaceGrid = typename TrimmerType<dim,ScalarType>::ParameterSpaceGrid;
      static const bool v      = false;
    };
    ...
    template <std::size_t dim, std::size_t dimworld, typename ScalarType, template<int,typename > typename TrimmerType>
    struct viewThreadSafe<Dune::Grid<dim, dimworld, ScalarType, IGANEW::PatchGridFamily<dim, dimworld, TrimmerType,ScalarType>>> {
      using ParameterSpaceGrid = typename TrimmerType<dim,ScalarType>::ParameterSpaceGrid;
      static const bool v      = false;
    };
    ...
    template <std::size_t dim, std::size_t dimworld, typename ScalarType, template<int,typename > typename TrimmerType>
    struct isCartesian<Dune::Grid<dim, dimworld, ScalarType, IGANEW::PatchGridFamily<dim, dimworld, TrimmerType,ScalarType>>> {
      using ParameterSpaceGrid = typename TrimmerType<dim,ScalarType>::ParameterSpaceGrid;
      static const bool v      = false;
    };
