...
namespace Dune::IGA {
  ...
  public:
    ...
    using HostGridGeometry= typename std::conditional<coorddim==DimensionWorld, HostGridGeometryType, HostGridLocalGeometryType>::type;
    ...
    PatchGridGeometry(const HostGridGeometry& hostGeometry)
  : hostGeometry_(hostGeometry){
    }
