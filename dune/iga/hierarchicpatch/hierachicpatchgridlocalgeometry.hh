...
namespace Dune::IGANEW {
  ...
  class TrimmedPatchGridLocalGeometry
   ...
   public:
    ...
    /** constructor from host geometry
     */
    TrimmedPatchGridLocalGeometry(const HostGridGeometry& hostGeometry, GeometryLocalView&& geometryLocalView)
        : hostGeometry_(hostGeometry), geometryLocalView_(std::forward<GeometryLocalView>(geometryLocalView)) {
      geometryLocalView_.bind(hostGeometry_.impl());
    }

    TrimmedPatchGridLocalGeometry(const HostGridGeometry& hostGeometry) : hostGeometry_(hostGeometry) {}
