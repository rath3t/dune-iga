...
class NURBSGridLeafIndexSet : public IndexSet<GridImpl, NURBSGridLeafIndexSet<GridImpl>, int, std::vector<GeometryType>>
{
public:
  ...
  explicit NURBSGridLeafIndexSet(const NURBSLeafGridView<GridImpl>& g)
      : gridView_(&g) {}
...
private:
  ...
  const NURBSLeafGridView<GridImpl>* gridView_;
};
} // namespace Dune::IGA
