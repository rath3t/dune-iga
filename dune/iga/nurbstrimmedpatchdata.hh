...
namespace Dune::IGA {
  ...
  struct NURBSTrimmedPatchData {
    ...
    NURBSTrimmedPatchData() = default;
    NURBSTrimmedPatchData(const std::array<std::vector<double>, dim>& knotSpansI, const ControlPointNetType& controlPointsI,
